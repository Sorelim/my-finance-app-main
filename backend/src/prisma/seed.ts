...
async function main() {
        ...
        create: {
          ...
          transactions: {
            create: [
              ...
              {
                avatar: "/images/avatars/spark-electric-solutions.jpg",
                name: "Piru Electric Solutions",
                category: "Bills",
                date: "2025-02-24T09:25:51Z",
                amount: -100.0,
                recurring: true,
              },
              {
                avatar: "/images/avatars/spark-electric-solutions.jpg",
                name: "Oi Electric Solutions",
                category: "Bills",
                date: "2025-02-27T09:25:51Z",
                amount: -100.0,
                recurring: true,
              },
            ],
  ...
  console.log("User and finance data created:", user)
}
